...
// key: "fakecache" / <store path hash (nix base32)>
// value:
type FakeCacheData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Narinfo       []byte                 `protobuf:"bytes,1,opt,name=narinfo,proto3" json:"narinfo,omitempty"`
...
func (x *FakeCacheData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FakeCacheData) ProtoMessage() {}

func (x *FakeCacheData) ProtoReflect() protoreflect.Message {
	mi := &file_db_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FakeCacheData.ProtoReflect.Descriptor instead.
func (*FakeCacheData) Descriptor() ([]byte, []int) {
	return file_db_proto_rawDescGZIP(), []int{2}
}

func (x *FakeCacheData) GetNarinfo() []byte {
	if x != nil {
		return x.Narinfo
	}
	return nil
...
func (x *FakeCacheData) GetUpstream() string {
	if x != nil {
		return x.Upstream
	}
	return ""
...
func (x *FakeCacheData) GetUpdated() int64 {
	if x != nil {
		return x.Updated
	}
	return 0
...
const file_db_proto_rawDesc = "" +
	...
	"\x06pubkey\x18\x02 \x03(\tR\x06pubkey\"_\n" +
	"\rFakeCacheData\x12\x18\n" +
	"\anarinfo\x18\x01 \x01(\fR\anarinfo\x12\x1a\n" +
	"\bupstream\x18\x02 \x01(\tR\bupstream\x12\x18\n" +
	"\aupdated\x18\x03 \x01(\x03R\aupdated*\x89\x01\n" +
	"\n" +
	"MountState\x12\v\n" +
...
var file_db_proto_goTypes = []any{
	...
	(*FakeCacheData)(nil), // 3: pb.FakeCacheData
	(*DaemonParams)(nil),  // 4: pb.DaemonParams
}
var file_db_proto_depIdxs = []int32{
	0, // 0: pb.DbImage.mount_state:type_name -> pb.MountState
	4, // 1: pb.DbParams.params:type_name -> pb.DaemonParams
