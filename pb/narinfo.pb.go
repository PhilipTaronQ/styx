...
const file_narinfo_proto_rawDesc = "" +
	"\n" +
	"\rnarinfo.proto\x12\x02pb\"\xce\x02\n" +
	"\aNarInfo\x12\x1d\n" +
	"\n" +
	"store_path\x18\x01 \x01(\tR\tstorePath\x12\x10\n" +
	...
	"\bnar_hash\x18\x06 \x01(\tR\anarHash\x12\x19\n" +
	"\bnar_size\x18\a \x01(\x03R\anarSize\x12\x1e\n" +
	"\n" +
	"references\x18\b \x03(\tR\n" +
	"references\x12\x18\n" +
	"\aderiver\x18\t \x01(\tR\aderiver\x12\x16\n" +
	"\x06system\x18\n" +
	" \x01(\tR\x06system\x12\x1e\n" +
	"\n" +
...
var (
	...
	file_narinfo_proto_rawDescData []byte
)

func file_narinfo_proto_rawDescGZIP() []byte {
	file_narinfo_proto_rawDescOnce.Do(func() {
		file_narinfo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_narinfo_proto_rawDesc), len(file_narinfo_proto_rawDesc)))
	})
...
func file_narinfo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_narinfo_proto_rawDesc), len(file_narinfo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
